...
monster.attacks = {
	...
	{name ="wave t", interval = 2000, chance = 10, minDamage = -300, maxDamage = -580, target = false},
	...
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -520, length = 5, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}
